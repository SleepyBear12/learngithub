...
<head>
    ...
    <title>{{ $title ?? 'Admin Dashboard' }} - EVChargeHub</title>
...
<aside class="sidebar" id="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li>
                <a href="{{ url('/admin/operator') }}"
                   class="{{ request()->is('admin/operator*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ url('/admin/role-hak-akses') }}"
                   class="{{ request()->is('admin/role-hak-akses*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ url('/admin/lokasi-pengisian') }}"
                   class="{{ request()->is('admin/lokasi-pengisian*') ? 'active' : '' }}">
                    <i class="bi bi-geo-alt-fill"></i>
                    <span>Lokasi Pengisian</span>
                </a>
            </li>

            <li>
                <a href="{{ url('/admin/pengisi-daya') }}"
                   class="{{ request()->is('admin/pengisi-daya*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ url('/admin/sesi-pengisian') }}"
                   class="{{ request()->is('admin/sesi-pengisian*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ url('/admin/audit') }}"
                   class="{{ request()->is('admin/audit*') ? 'active' : '' }}">
    ...
    <div class="account-section">
        ...
        <a href="{{ url('/admin/profil') }}" class="profile-link">
    ...
    <header class="topbar">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="page-heading">
                ...
                <h1>{{ $pageTitle ?? 'Dashboard Admin' }}</h1>
            </div>
